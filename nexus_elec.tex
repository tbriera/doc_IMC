...
In this section, we present the main electricity nexus outputs from 2015 to 2100 in two scenarios : a Nationally Determined Contribution scenario, following COMMIT project results (\cite{VanSoest2021}) and a 2°C scenario (1000 GT CO2 budget, 2020-2100).
...
% graph 1 : total generation in Twh/EJ
%\begin{figure}[H]
%    \centering
%    \subfloat[\centering NDC]{{\includegraphics[scale=0.15]{figures&tables/Prod_doc_2deg.png} }}%
%    \qquad
 %   \subfloat[\centering 2°C]{{\includegraphics[scale=0.15]{figures&tables/Prod_doc_2deg.png} }}%
 %   \caption{2 Figures side by side}%
 %   \label{fig:example}%
%\end{figure}

% graph 2 (stacked bar chart) : installed capacity in 2020 - 2030 -  2050 - 2070 - 2100, almost OK

% graph 3 : electricity prices with classic outputviz script
